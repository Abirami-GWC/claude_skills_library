# Negotiation endgame playbook

For deals that have effectively been agreed to verbally but have stalled before signature —
different from the earlier-stage objections in `handlers/top-objections-playbook.md` because
there's usually no new *objection* being raised, just friction, silence, or a soft new condition
appearing late.

## How to use this file

These aren't classified by `scripts/classify_objection.py` — they're a distinct pattern, not a
single objection sentence. Recognize the pattern first, then use the matching move.

## Endgame patterns

| Pattern | What's actually happening | Move |
|---|---|---|
...
Same as the pricing handler: no discount, credit, or scope concession gets stated as agreed in
this handler's output. Concessions get routed to the approved owner, not generated here.

## When this overlaps with roleplay practice

`handlers/objection-roleplay-simulator.md` is built for objection-style pushback earlier in a
call. Endgame stalls are less about what to *say* and more about diagnosing *why* a deal stopped
moving — if a rep wants to rehearse this stage, adapt the roleplay simulator's format but draw
scenarios from this file's patterns instead of the objection tables.

*(Placeholder patterns for a mid-market B2B sales motion — adjust to the team's actual deal-desk
and procurement process before production use.)*
